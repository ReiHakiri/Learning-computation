...
def is_simulation(system1: FiniteSystem, system2: FiniteSystem, steps: list[int], translation: list[int], sublist: list[int]) -> bool:
    '''
    Precondition:
    - len(steps) == len(sublist)
    - translation is a permutation of system2's states
...
while True:
    system1 = FiniteSystem(rand_function_list(10), 0)
    system2 = FiniteSystem(rand_function_list(4), 0)
